...
class AutocompleteManager {
  ...
  handleEvents () {
    ...
    this.subscriptions.add(this.suggestionList.onDidSelect(suggestion => {
  ...
  handleCommands () {
    return this.subscriptions.add(atom.commands.add('atom-text-editor', {
      ...
      'autocomplete-plus:menu:1': () => { this.selectSuggestionAndConfirm(0) },
      'autocomplete-plus:menu:2': () => { this.selectSuggestionAndConfirm(1) },
      'autocomplete-plus:menu:3': () => { this.selectSuggestionAndConfirm(2) },
      'autocomplete-plus:menu:4': () => { this.selectSuggestionAndConfirm(3) },
    }))
  }
